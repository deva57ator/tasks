...
import { initGraphFeature } from './src/graph.js';
...
const graphFeature=initGraphFeature({
  getCurrentView:()=>currentView,
  getTasks:()=>tasks,
  totalTimeMs,
  isHolidayDay:(y,m,d)=>isHolidayDay(y,m,d),
  isWeekendDay:(y,m,d)=>isWeekendDay(y,m,d),
...
function render(){
  ...
  if(currentView==='graph'){document.getElementById('viewTitle').textContent='График';graphFeature.renderGraphMonth(wrap);updateWorkdayUI();return}
